...
<div>
    <span class="original-price">Original Price: $100</span><br>
    <span class="discount-amount hidden">Discount: $20</span><br>
    <span class="grand-total">Grand Total: $100</span>
</div>

<script>
    const fixedCouponCode = "SAVE20"; // Predefined coupon code
    const discountAmount = 20; // Discount amount
    ...
    function checkCouponCode() {
        var inputCode = document.getElementById('coupon-input').value.trim();
        var discountSpan = document.querySelector('.discount-amount');
        var grandTotalSpan = document.querySelector('.grand-total');
        var errorMessage = document.getElementById('error-message');
        var originalPrice = 100; // Original price of the product

        if (inputCode === fixedCouponCode) {

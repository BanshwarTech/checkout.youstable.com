...
{
    global $con; // Ensure the database connection is accessible

    // Use prepared statements to prevent SQL injection
    $stmt = $con->prepare("SELECT currency FROM currency WHERE country_code = ?");
    ...
    if ($result && $result->num_rows > 0) {
        ...
        return $row['currency']; // Return the currency from the database
    }
